...
Warbler::Config.new do |config|
  ...
  config.features = %w(runnable executable compiled)
  ...
  # the application.
  # config.compiled_ruby_files = FileList['app/**/*.rb  ', 'lib/**/*.rb', 'config/*.rb' ]
  # config.includes = FileList["app.rb"]
  # config.compiled_ruby_files = FileList["*.rb"]
  # compile all files exclude some file
  ...
  # config.public_html = FileList["public/**/*", "doc/**/*", ".ebextensions/**/*"]
# +  config.public_html = FileList["public/**/*", "public/assets/images/**/*", ".ebextensions/**/*"]
